#include<bits/stdc++.h>
using namespace std;
int arr[]= {3,1,5,6,2,18,20,21,22,25,26,7,9,28,29,31,33,13,16,10,11,34,35,36,37,38,39};
...
void menu()
{
    ...
    cout<<"\t\t\t\t\t"<<"35. Kacchi biriany           160.00"<<endl;

    cout<<"\t\t\t\t\t\t"<<" DRINKS"<<endl<<endl;
    cout<<"\t\t\t\t\t"<<"36. sprite                   30.00"<<endl;
    cout<<"\t\t\t\t\t"<<"37. CocaCola                 30.00"<<endl;
    cout<<"\t\t\t\t\t"<<"38. Fanta                    30.00"<<endl;
    cout<<"\t\t\t\t\t"<<"39. Lassi                    80.00"<<endl;
...
void rolls()
{
    ...
    else
    {
        ...
        else
        {
            ...
            cout<<"\t\t\t\t\t"<<"Quantity : ";
            cin>>m;
            cout<<"if you want choose another item,press * , otherwise press any key : ";
            char x;
            cin>>x;
            if(x=='*')
            {
